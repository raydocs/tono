...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            tono::commands::account::tono_sign_in_start,
            tono::commands::account::tono_sign_in_verify,
            tono::commands::account::tono_sign_out,
            tono::commands::account::tono_account,
            tono::commands::account::tono_devices,
            tono::commands::account::tono_revoke_device,
            tono::commands::catalog::tono_servers,
            ...
            tono::exit_transport::tono_exit_transport,
            tono::exit_transport::tono_set_exit_transport,
            ...
            tono::commands::connection_cmd::tono_connect,
            tono::commands::connection_cmd::tono_disconnect,
            tono::commands::connection_cmd::tono_status,
            tono::commands::connection_cmd::tono_close_connection,
            tono::commands::connection_cmd::tono_close_all_connections,
            tono::commands::restore::tono_retry_restore,
            tono::commands::diagnostics::tono_audit_enabled,
            tono::commands::diagnostics::tono_set_audit_enabled,
            tono::commands::diagnostics::tono_periodic_telemetry_enabled,
            tono::commands::diagnostics::tono_automatic_diagnostics_enabled,
            tono::commands::diagnostics::tono_set_automatic_diagnostics_enabled,
            ...
            tono::commands::diagnostics::tono_set_network_log_upload_enabled,
            tono::commands::diagnostics::tono_audit_log_path,
