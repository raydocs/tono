...
pub mod files {
    pub const RUNTIME_CONFIG: &str = "tono-runtime.yaml";
    pub const CHECK_CONFIG: &str = "tono-runtime-check.yaml";
    pub const LEGACY_RUNTIME_CONFIG: &str = "clash-verge.yaml";
    pub const LEGACY_CHECK_CONFIG: &str = "clash-verge-check.yaml";
