...
- Restored a routing allowlist entry the live policy depends on. Rejecting one unknown entry discards the whole policy, so its removal had silently dropped every WeChat pin and every China-direct acceleration route.
