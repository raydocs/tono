...
- The network helper is 4.2.0. Upgrading from pre-4.2.0 installs will require an administrator password once; all subsequent helper updates are applied silently and securely without password prompts.
