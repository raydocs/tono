...
- 续记 2026-09-26：#639 已合 main（merge fb5e8485，helper 协议 4.48.0）。内部候选 0.0.73 build73（源码 fb5e8485；macOS run 36212061109、Windows run 36212062220）包含本修复，未发布到客户通道，实机待测。`-E` 超时找回的认领范围与记录写失败回退的续修见 #643（未合，协议 4.49.0）。
