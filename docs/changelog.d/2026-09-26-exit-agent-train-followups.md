...
- 续记 2026-09-26：#638 已合 main（merge 779b4876）。控制面与 admin Worker 从 main@57c1c64c 部署（含 `revoked_token_hash`，部署前未导出 D1）；13 个装 agent 的节点 exit-agent 换为 main@#638 版本（md5 b50edcbe…），后又换为 #641 版本（见该条目）。
