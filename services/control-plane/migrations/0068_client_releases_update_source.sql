...
-- of it was asked for; `createRelease` refuses a new row without them, and
-- `publish` refuses a row that was never verified — which is the honest way to
-- treat history without pretending it was checked.
