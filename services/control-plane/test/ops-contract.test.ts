...
const CASES: Array<[string, (value: unknown, path?: string) => unknown, () => Record<string, unknown>]> = [
  ...
  ['retireDependencies', assertRetireDependencies, () => ({
    customersOnNode: [{ userId: 'u-1', email: 'a@example.com', lastSeenAt: 1_757_000_000 }],
    defaultProxyBindings: 1,
    exitTokenActive: true,
    lastRosterAt: 1_757_000_000,
  })],
  ...
  ['monthSummary', assertMonthSummary, () => ({
    month: '2026-09',
    closedAt: null,
    closedBy: null,
    revenueCnyMinor: 71280,
    costCnyMinor: 20000,
    marginCnyMinor: 51280,
    byCategory: {
      plan: 71280, server: 15000, home_line: 0, domain: 0, control_plane: 0,
      claude_account: 5000, chatgpt_account: 0, other: 0,
    },
    customers: [{
  ...
  ['monthReconRow', assertMonthReconRow, monthReconRow],
  ['worthwhile', assertWorthwhile, worthwhile],
  ['fxRate', assertFxRate, () => ({
    day: '2026-09-10',
    base: 'USD',
    quote: 'CNY' as const,
