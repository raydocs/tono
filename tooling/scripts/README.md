...
test and packaging scripts normally run on the existing GitHub-hosted CI,
not automatically on the maintainer's MacBook. A script named `local` runs
...
to remote workers nor authorizes privileged tests. Native-device acceptance
